...
//     getCoinsData();
//   }, [currency]);
//   function sortCoinsByPriceDescending(coins) {
//     return coins.sort((a, b) => b.current_price - a.current_price);
//   }

//   const coin = sortCoinsByPriceDescending(coins);
...
const Coins = () => {
  ...
  useEffect(() => {
    ...
    getCoinsData();
  }, [currency]); // Dependencies are currency here
    ...
    <>
      {loading ? (
        ...
        <>
          ...
          {coin
            .filter((data) => {
              // Make sure that `filter` function returns a boolean value
